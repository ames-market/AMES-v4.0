...
public class PowerGridConfigure2 extends javax.swing.JFrame {
	...
	public PowerGridConfigure2(AMESFrame frame) {
		...
		this.addRowItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				PowerGridConfigure2.this.addRowItemActionPerformed(evt);
			}
		});
		...
		this.copyRowItem.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				PowerGridConfigure2.this.copyRowItemActionPerformed(evt);
			}
		});
		...
		this.pasteRowItem.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				PowerGridConfigure2.this.pasteRowItemActionPerformed(evt);
			}
		});
		...
		this.deleteRowItem.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				PowerGridConfigure2.this.deleteRowItemActionPerformed(evt);
			}
		});

		this.setTitle("Step 2: Input grid branch parameters");
		...
		this.jTable1.setToolTipText("Power Grid Line Parameters Table");
		...
		this.jTable1.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent evt) {
				if (evt.isPopupTrigger()) {
					PowerGridConfigure2.this.popupMenu.show(evt.getComponent(), evt.getX(), evt.getY());
				}
			}
			@Override
	...
	private void addRowItemActionPerformed(java.awt.event.ActionEvent evt) {
		...
		this.mainFrame.addBranchNumber( );
	}
	...
	private void deleteRowItemActionPerformed(java.awt.event.ActionEvent evt) {
		...
		this.jTable1.repaint();
		this.mainFrame.deleteBranchNumber();
	}
	...
	public void addRowsBlankData(int iRow) {
		...
		for(int i=1; i<iRow; i++) {
			tableModel.insertRow(1, this.blankRowData );
		}
	...
	public Object [][] saveData( ) {
		...
		this.mainFrame.setdBranchNumber(iRowCount);
		return returnData;
	}
	...
	private void initComponents() {
		...
		jPanel1Layout.setHorizontalGroup(
				...
				.addGroup(jPanel1Layout.createSequentialGroup()
						.addGap(18, 18, 18)
						.addComponent(this.jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 529, javax.swing.GroupLayout.PREFERRED_SIZE)
		...
		jPanel1Layout.setVerticalGroup(
				...
				.addGroup(jPanel1Layout.createSequentialGroup()
						.addGap(38, 38, 38)
						.addComponent(this.jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 182, javax.swing.GroupLayout.PREFERRED_SIZE)
		...
		this.CancelButton.addActionListener(new java.awt.event.ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				PowerGridConfigure2.this.CancelButtonActionPerformed(evt);
			}
		});
		...
		this.NextButton.addActionListener(new java.awt.event.ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				PowerGridConfigure2.this.NextButtonActionPerformed(evt);
			}
		});
		...
		this.PrevButton.addActionListener(new java.awt.event.ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				PowerGridConfigure2.this.PrevButtonActionPerformed(evt);
			}
		});
		...
		this.DataVerifyButton.addActionListener(new java.awt.event.ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				PowerGridConfigure2.this.DataVerifyButtonActionPerformed(evt);
			}
		});
		...
		layout.setHorizontalGroup(
				...
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
						...
						.addGap(117, 117, 117)
						.addComponent(this.CancelButton, javax.swing.GroupLayout.DEFAULT_SIZE, 69, Short.MAX_VALUE)
						.addGap(27, 27, 27)
						.addComponent(this.PrevButton, javax.swing.GroupLayout.DEFAULT_SIZE, 68, Short.MAX_VALUE)
						.addGap(26, 26, 26)
						.addComponent(this.NextButton, javax.swing.GroupLayout.DEFAULT_SIZE, 68, Short.MAX_VALUE)
						.addGap(19, 19, 19))
				);
	...
	public String DataVerify() {
		...
		for(int i=0; i<verifyData.length; i++) {
			...
			if(Support.parseDouble(verifyData[i][4].toString())<0.0) {
		...
		/* Doesn't work for the 8-bus version being developed. Input
		 * data should be good, so I'm not sure what's wrong. Ignore it
		 * until we can fix it.
		 * for(int i=0; i<iBranch; i++) {
            int iSmallNodeNo=0;
            int iBigNodeNo=0;
	...
	private void PrevButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PrevButtonActionPerformed
		this.setVisible(false);
		this.mainFrame.activeConfig1();
	}//GEN-LAST:event_PrevButtonActionPerformed

	private void NextButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NextButtonActionPerformed
		this.setVisible(false);
		this.mainFrame.activeConfig4();
