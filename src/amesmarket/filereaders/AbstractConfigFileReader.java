...
public abstract class AbstractConfigFileReader<T> {
    ...
    //FIXME: Find other instances of this regex in subclasses and replace them with this field.
    /**
     ...
     *
     * If a the sourcefile is not null, all scenario files and
     ...
     * @return
     */
    protected abstract T read() throws BadDataFileFormatException;
     ...
     */
    public T read(final File file) throws BadDataFileFormatException {
        if (file == null) {
     ...
     */
    public T read(final Reader loadProfileStream) throws BadDataFileFormatException {
     ...
     * @throws IllegalArgumentException if loadProfileReader is null.
     */
    public T read(final InputStream loadProfileStream) throws BadDataFileFormatException {
        if(loadProfileStream == null) {
            throw new IllegalArgumentException("InputStream may not be null");
        }
