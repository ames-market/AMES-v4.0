...
public class TransGrid {
    ...
    public TransGrid(double[][] nodeData, double[][] branchData,
                     int xSize, int ySize, INIT init) {
        if(init == null) throw new IllegalArgumentException("Null INIT object in TransGrid construction.");
    ...
    public double[][] getVADWeight() {
        return vadWeight;
    }
    public double[][] getReducedVADWeight() {
        return reducedVADWeight;
    }
    ...
    public void addGenAgentAtNodeK(GenAgent gen, int k) {
        ...
        /*else {
            System.err.println("[WARNING] k = " + k
                               + ". Adding agent with k > 3. Ignoring!");
        }*/
    }
